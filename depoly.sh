...
envs_dir=$envs_name/$projects_name
...
echo -e "\e[35m source $projects_dir/$envs_dir/bin/activate success \e[0m"
...
callable = app
processes = 1
virtualenv = $current_dir/$envs_name/" > $projects_dir"_uwsgi.ini"
